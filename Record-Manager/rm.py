...
def submit():
    with open("record.txt", "a") as f:
        f.write(f"Username = {nameValue.get()}, Register no = {passValue.get()}, Email = {emailValue.get()}, Phone number = {phoneValue.get()}, agreement = {agreementValue.get()}\n")
...
Label(root, text="Register no\t \t -", font="lucida 15 bold").grid(row=3, column=3)
